...
# Form implementation generated from reading ui file 'bookingkursi_ekonomi.ui'
#
...
class Ui_kereta_ekonomi(object):
    def setupUi(self, kereta_ekonomi):
        kereta_ekonomi.setObjectName("kereta_ekonomi")
        kereta_ekonomi.resize(1280, 766)
        kereta_ekonomi.setMaximumSize(QtCore.QSize(1280, 766))
        kereta_ekonomi.setStyleSheet("background: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #6a11cb, stop:1 #2575fc);\n"
"")
        self.kereta_box = QtWidgets.QFrame(kereta_ekonomi)
        self.kereta_box.setGeometry(QtCore.QRect(30, 10, 1121, 730))
...
"")
        ...
        self.kursi_kereta_box.setGeometry(QtCore.QRect(30, 70, 1041, 641))
        ...
        self.frame_data_kereta.setGeometry(QtCore.QRect(130, 10, 781, 51))
        ...
        self.button_pilihkursi.setGeometry(QtCore.QRect(40, 520, 991, 41))
        font = QtGui.QFont()
...
"")
        ...
        self.button_keluar.setGeometry(QtCore.QRect(40, 570, 991, 41))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        font.setBold(True)
...
"")
        ...
        self.label_pilih_kursi.setGeometry(QtCore.QRect(30, 10, 1041, 51))
        self.label_pilih_kursi.setMaximumSize(QtCore.QSize(1280, 766))
        font = QtGui.QFont()
        ...
        self.label_5 = QtWidgets.QLabel(kereta_ekonomi)
        ...
        self.retranslateUi(kereta_ekonomi)
        QtCore.QMetaObject.connectSlotsByName(kereta_ekonomi)

    def retranslateUi(self, kereta_ekonomi):
        _translate = QtCore.QCoreApplication.translate
        kereta_ekonomi.setWindowTitle(_translate("kereta_ekonomi", "Dialog"))
        self.pilih_gerbong.setText(_translate("kereta_ekonomi", "PILIH GERBONG KERETA "))
        self.nama_kereta.setText(_translate("kereta_ekonomi", "NAMA KERETA"))
        self.button_pilihkursi.setText(_translate("kereta_ekonomi", "PILIH"))
        self.button_keluar.setText(_translate("kereta_ekonomi", "KELUAR"))
        self.label_pilih_kursi.setText(_translate("kereta_ekonomi", "PILIH KURSI ANDA"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    kereta_ekonomi = QtWidgets.QDialog()
    ui = Ui_kereta_ekonomi()
    ui.setupUi(kereta_ekonomi)
    kereta_ekonomi.show()
    sys.exit(app.exec_())
